...
# EXPLORE DATA - TRANSACTIONS
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv(r"D:\Coding\Guvi-Assignments\Assignments-\Phonepe\nameofstates.csv")
            df1.State = df2

            fig = px.choropleth(df1,geojson="D:\Coding\Guvi-Assignments\Assignments-\Phonepe\statesofIndia.geojson.txt",
